...
class WhatsApp extends Component {
    constructor(props) {
        ...
        this.createWhatsApp = this.createWhatsApp.bind(this)
    ...
    deleteWhatsApp(id) {
        if (id !== null) {
            ...
            console.log(body)
            fetch(url + '/api/deleteWhatsApp', { method: "DELETE", headers: headers,body:JSON.stringify(body) })
                .then(res => res.json())
                .then(data => {
    ...
    createWhatsApp() {
        ...
        if (title.length === 0) {
            ...
            console.log(data)
            fetch(fetchURL + '/api/addWhatsapp', { method: "POST", body: JSON.stringify(data), headers: headers })
                .then(res => res.json())
                .then(data => {
                    if (data.message === 'Success') {
            ...
            fetch(url + '/api/getWhatsapp',
                ...
                .then(dat => {
                    if (dat.message === 'Success') {
                        ...
                        alert("failed to fetch WhatsApp")
                    }
            ...
            <div>
                ...
                {this.state.renderPage &&
                    <div>
                                            ...
                                            <div className="card-header">
                                                <div className='row'>
                                                    <div className='col-md-4'>
                                                        <b style={{ fontSize: 20 }}>WhatsApp Groups</b>
                                                    </div>
                                                    <div className='col-md-6'>
                                                    </div>
                                                    <div className='col-md-2'>
                                                        <button onClick={() => this.setState({ showWhatsAppModal: true })} className='btn btn-primary'>Add Group</button>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                {this.state.customer.length > 0 && this.state.customer.map((user, index) => {
                                                                    ...
                                                                    return (
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td><button onClick={() => this.deleteWhatsApp(user._id)} className='btn btn-danger'>Delete</button></td>
                                                                        </tr>
                                                                    )
                                                                }
                                                                )}
                        ...
                        <Modal centered toggle={() => this.setState({ showWhatsAppModal: false })} isOpen={this.state.showWhatsAppModal} onClose={this.onCloseModal}>
                            <br />
                            <br />
                            <h2 style={{ textAlign: "center" }}>Add WhatsApp</h2>
                            <br />
                            <input
                                type='text'
                            ...
                            name='description'
                            onChange={this.handleChange}
                            class="form-control" rows="4" placeholder='Description' id="description" style={{ resize: 'none' }}></textarea>
                            <br />
                            <input
                                type='text'
                                className='form-control'
                            ...
                            <div className='row'>
                                ...
                                <div className='col-md-3'>
                                    <button className='btn btn-primary' onClick={this.createWhatsApp} style={{ width: 100 }}>Create</button>
                                </div>
                                <div className='col-md-2'>
...
export default connect(mapStateToProps, mapActionsToProps)(WhatsApp)